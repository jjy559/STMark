...
public class Data {
    ...
    public Data(String filePath,char ch) throws IOException, CsvValidationException {
        //BufferedReader reader = new BufferedReader(new FileReader(filePath));
     ...
     * textual dataset
     */
    public Data(String filePath, int cls,int num,int[] Attrs) throws IOException, CsvValidationException {
        Reader reader = Files.newBufferedReader(Paths.get(filePath));
        CSVReader csvReader = new CSVReader(reader);
        String[] record;
        dataFre = new Vector<>();
